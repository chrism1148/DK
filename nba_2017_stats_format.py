...
for row in reader:
	...
	double_double     = row[20]
	triple_double     = row[21]
	
	fd_salary         = row[22]
	fd_salary_change  = row[23]
	dk_salary         = row[24]
	dk_salary_change  = row[25]
	# dd_salary         = row[22]
	# dd_salary_change  = row[23]
	yh_salary         = row[28]
	yh_salary_change  = row[29]
	...
	stats             = row[19].replace('pt',' points,')
