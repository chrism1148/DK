...
contest_path = ('/Users/chrismccallan/downloads/')
output_path = ('/Users/chrismccallan/downloads/')

ifile  = os.path.join(contest_path, 'contest-standings-%d.csv' % (contest_id))
ofile  = os.path.join(output_path, 'dk_mlb_%s_%d_formatted.csv' % (contest_name, contest_date)) 
ofile  = open(ofile, 'w')
